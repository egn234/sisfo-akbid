...
<body class="sb-nav-fixed">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="float-end">
                                ...
                                <div class="btn-group">
                                    <button data-bs-toggle="modal" data-bs-target="#importRuangan" class="btn btn-sm btn-success">
                                        Import data ruangan
                                    </button>
                                    <a href="<?= base_url() ?>assets/template/ruangan.xlsx" class="btn btn-sm btn-outline-success">Unduh Template Excel</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
    ...
    <div id="importRuangan" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('admin/ruangan/import-ruangan') ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
