                ...
                <form action="<?= base_url('admin/matkul/input-process') ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="kodeMatkul" placeholder="KODE MATA KULIAH">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">NAMA MATA KULIAH</label>
                            <input type="text" class="form-control" name="namaMatkul" placeholder="NAMA MATA KULIAH">
                        </div>
                        <div class="mb-3">
