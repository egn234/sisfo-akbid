                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse <?=($title == 'Daftar Mahasiswa' || $title == 'Daftar Dosen' || $title == 'Daftar Mata Kuliah' || $title == 'Daftar Ruangan' || $title == 'Daftar Tahun Ajaran' || $title == 'Daftar Kelas' || $title == 'Daftar Pertanyaan')?'show':''?>" id="kelolaMD" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link <?= ($title == 'Daftar Pertanyaan')?'active':''?>" href="<?= url_to('admin/pertanyaan') ?>">Pertanyaan</a>
